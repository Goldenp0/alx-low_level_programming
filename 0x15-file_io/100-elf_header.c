 ...
 * @e_ident: pointer to array containing the ELF magic digits.
 *
 ...
 * @e_ident: A pointer to an array contaaining the ELF magic numbers.
 *
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	s = read(o, header, sizeof(Elf64_Ehdr));
	if (s == -1)
	{
		free(header);
		close_elf(o);
